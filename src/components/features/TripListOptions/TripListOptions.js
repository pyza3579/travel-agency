...
class TripListOptions extends React.Component {
  ...
  handleDuration(type, value){
    if(type == 'from') {
      console.log('Changing duration', type);
      this.props.changeTripDuration(value);
    } else {
...
TripListOptions.propTypes = {
  ...
  addTripTag: PropTypes.string,
  removeTripTag: PropTypes.string,
  changeTripDuration: PropTypes.number,
};
